...
public class WordsToNumbersUtilTest {
	...
	public static Stream<Arguments> specialCasesTestData() {
		return Stream.of( 
			Arguments.of("Two lines","Two lines test. \nSecond line with five words.","2 lines test. \\nSecond line with 5 words."),
			...
			Arguments.of("Consecutive equal multiplier","six hundred two hundred two.","600 202."),
